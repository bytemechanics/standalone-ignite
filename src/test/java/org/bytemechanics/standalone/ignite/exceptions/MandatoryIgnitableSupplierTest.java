 ...
 * @author afarre
 */
public class MandatoryIgnitableSupplierTest {
	
	@BeforeAll
	public static void setup() throws IOException {
		System.out.println(">>>>> MandatoryIgnitableSupplierTest >>>> setup");
	...
	public void constructor() {
		final MandatoryIgnitableSupplier instance=new MandatoryIgnitableSupplier();
		Assertions.assertEquals(MandatoryIgnitableSupplier.MESSAGE ,instance.getMessage());
	}
}
