 ...
 * @author afarre
 */
public class FontNotReadableTest {
	
	@BeforeAll
	public static void setup() throws IOException {
		System.out.println(">>>>> FontNotReadableTest >>>> setup");
	...
	public void constructor() throws MalformedURLException {
		final FontNotReadable instance=new FontNotReadable(new URL("http://my-url"),new IOException());
		Assertions.assertEquals(SimpleFormat.format(FontNotReadable.MESSAGE,new URL("http://my-url")) ,instance.getMessage());
	}
}
