 ...
 * @author afarre
 */
public class NullOrEmptyMandatoryParameterTest {
	
	@BeforeAll
	public static void setup() throws IOException {
		System.out.println(">>>>> NullOrEmptyMandatoryParameterTest >>>> setup");
	...
	public void constructor(@Mocked Parameter _parameter) {
		...
		final NullOrEmptyMandatoryParameter instance=new NullOrEmptyMandatoryParameter(_parameter);
		Assertions.assertEquals(SimpleFormat.format(NullOrEmptyMandatoryParameter.MESSAGE,NAME,Stream.of(PREFIXES)
																									.map(prefix -> prefix+":")
	...
	public void constructor() {
		...
		final NullOrEmptyMandatoryParameter instance=new NullOrEmptyMandatoryParameter(null);
		Assertions.assertEquals(SimpleFormat.format(NullOrEmptyMandatoryParameter.MESSAGE,null,Collections.emptyList()) 
								,instance.getMessage());
	}
}
