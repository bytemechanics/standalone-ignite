...
public class UnknownCommandTest {
	...
	public static void setup() throws IOException {
		System.out.println(">>>>> UnknownCommandTest >>>> setup");
	...
	public void constructor() {
		final UnknownCommand instance=new UnknownCommand("my-command","command1,command2,command3");
		Assertions.assertEquals(SimpleFormat.format(UnknownCommand.MESSAGE, "my-command","command1,command2,command3") ,instance.getMessage());
	}
}
