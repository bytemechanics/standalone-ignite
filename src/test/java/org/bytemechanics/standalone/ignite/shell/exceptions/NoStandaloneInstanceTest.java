 ...
 * @author afarre
 */
public class NoStandaloneInstanceTest {
	
	@BeforeAll
	public static void setup() throws IOException {
		System.out.println(">>>>> NoStandaloneInstanceTest >>>> setup");
	...
	public void constructor() {
		final NoStandaloneInstance instance=new NoStandaloneInstance();
		Assertions.assertEquals(NoStandaloneInstance.MESSAGE ,instance.getMessage());
	}
}
